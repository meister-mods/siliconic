...
- Autonomous equipment with distinct material input, consumption, and output slots is detected as a cleanroom equipment pollution source, including compatible machines from other mods. Existing furnace, combustion, and generator sources remain included. Shovel-mineable dirt, sand, gravel, and similar materials are counted separately as block pollution sources.
