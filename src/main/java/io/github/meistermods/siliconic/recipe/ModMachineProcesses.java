...
public final class ModMachineProcesses {
  ...
  public static boolean accepts(
      MachineKind machine, int relativeSlot, ItemStack stack) {
    for (MachineProcess process : all())
  ...
  private static List<MachineProcess> createProcesses() {
    return List.of(
        ...
        shaped(
            ...
            600,
            60,
            input(0, ModItems.PURE_SILICON.get()), input(1, Items.ECHO_SHARD),
            input(2, ModItems.PURE_SILICON.get()), input(3, Items.ECHO_SHARD),
            input(4, ModItems.VLSI_WAFER.get()), input(5, Items.ECHO_SHARD),
            input(6, ModItems.PURE_SILICON.get()), input(7, Items.ECHO_SHARD),
        ...
        shaped(
            ...
            500,
            60,
            input(0, ModItems.PURE_SILICON.get()), input(1, Items.NETHERITE_SCRAP),
            input(2, ModItems.PURE_SILICON.get()), input(3, Items.NETHERITE_SCRAP),
            input(4, ModItems.LSI_WAFER.get()), input(5, Items.NETHERITE_SCRAP),
            input(6, ModItems.PURE_SILICON.get()), input(7, Items.NETHERITE_SCRAP),
            input(8, ModItems.PURE_SILICON.get())),
        shaped(
            ...
            400,
            60,
            input(0, ModItems.PURE_SILICON.get()), input(1, Items.DIAMOND),
            input(2, ModItems.PURE_SILICON.get()), input(3, Items.DIAMOND),
            input(4, ModItems.MSI_WAFER.get()), input(5, Items.DIAMOND),
            input(6, ModItems.PURE_SILICON.get()), input(7, Items.DIAMOND),
            input(8, ModItems.PURE_SILICON.get())),
        shaped(
            ...
            300,
            60,
            input(0, ModItems.PURE_SILICON.get()), input(1, Items.GOLD_INGOT),
            input(2, ModItems.PURE_SILICON.get()), input(3, Items.GOLD_INGOT),
            input(4, ModItems.SSI_WAFER.get()), input(5, Items.GOLD_INGOT),
            input(6, ModItems.PURE_SILICON.get()), input(7, Items.GOLD_INGOT),
            input(8, ModItems.PURE_SILICON.get())),
        shapeless(
            ...
            200,
            60,
            input(SHAPELESS_SLOT, ModItems.PURE_SILICON.get()),
            input(SHAPELESS_SLOT, Items.IRON_NUGGET)),
        shaped(
            ...
            120,
            30,
            input(0, ModItems.COPPER_NUGGET.get()), input(1, Items.REDSTONE),
            input(2, ModItems.COPPER_NUGGET.get()), input(3, Items.REDSTONE),
            input(4, Items.AMETHYST_SHARD), input(5, Items.REDSTONE),
            input(6, ModItems.COPPER_NUGGET.get()), input(7, Items.REDSTONE),
        ...
        shaped(
            ...
            120,
            30,
            input(1, ModItems.COPPER_NUGGET.get()), input(3, Items.REDSTONE_TORCH),
            input(4, Items.QUARTZ), input(5, Items.REDSTONE_TORCH),
        ...
        shaped(
            ...
            120,
            30,
            input(1, Items.REDSTONE_TORCH), input(3, ModItems.COPPER_NUGGET.get()),
            input(4, Items.QUARTZ), input(5, ModItems.COPPER_NUGGET.get()),
            input(7, ModItems.COPPER_NUGGET.get())),
        shaped(
            ...
            120,
            30,
            input(0, ModItems.COPPER_NUGGET.get()), input(2, ModItems.COPPER_NUGGET.get()),
            input(4, Items.QUARTZ), input(5, Items.REDSTONE),
            input(6, ModItems.COPPER_NUGGET.get()), input(8, ModItems.COPPER_NUGGET.get())),
        shaped(
            ...
            120,
            30,
            input(1, ModItems.COPPER_NUGGET.get()), input(3, ModItems.COPPER_NUGGET.get()),
            input(4, Items.QUARTZ), input(5, ModItems.COPPER_NUGGET.get()),
